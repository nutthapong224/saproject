  ...
  const onSubmit = async (data) => {
    ...
    try {
      const profileImageUrl = profileImage
        ...
        : user?.profileUrl;
      const newData = profileImageUrl
        ? { ...data, profileUrl: profileImageUrl }
        : data;
      console.log("Final data with profile image URI:", newData);
      ...
      if (res) {
        const userData2 = { token: res.token, ...res.user };
              ...
              <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <label className="text-gray-600 text-sm mb-1">About</label>
                    <textarea
