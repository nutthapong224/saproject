...
import { footerLinks } from "../utills/data";
  ...
  return (
    <footer className="text-white mp-20">
      ...
      <div className="bg-[#1d4ed8]">
        <div className="contianer px-5 py-20 mx-auto">
        ...
        <div className="">
          ...
          <div className="contianer mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between">
            <div className="w-full md:w-2/4 lg:2-1/3 h-16 flex items-center justify-center md:justify-start">
              <TextInput
                style="w-full flex-grow md:w-40 2xl:w-64 bg-gray-100 sm:mr-4 md-2"
                type="email"
